...
export default {
    postlist: [ 
        ...
        },
        {
            ...
            "--문제는 이 다음에 어떤 종류의 웹앱을 구상하고 만들지 모르겠다는 것이다. 나는 항상 이상한 웹앱을 만드는 것을 좋아하기 때문에 뭔가를 만들거나 하기는 할 것 같은데 아직 떠오르는 것은 없다. 당분간은 npm 모듈이나 코딩연습을 커밋하면서 있지 않을까 싶다. 저장소는 <a href='https://github.com/rt2zz/redux-persist'>BEC</a>에서 확인할 수 있다.  " +
            "  " +
            "--2. react-navigation-guard  " +
            "  " +
            "--React에서 사용할 네비게이션 가드 모듈을 직접 만들어 보았다. 실제로 활용할 만한 가치가 있는지는 모르겠지만, 연습도 되고 꽤 흥미로웠다.  "
        }
    ]
}