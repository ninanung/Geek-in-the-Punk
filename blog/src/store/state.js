...
export default {
    postlist: [ 
        ...
        },
        {
            ...
            "  " +
            "<img src='./static/photos/penta-20180811/3.jpg' style='width: 100%; height: auto;' />  " +
            "--기이이이이이잇발. 일종의 락페스티벌 문화다. 재미있는 깃발을 보는 것도 일종의 재미라고 생각한다.  " +
            "  " +
            "<img src='./static/photos/penta-20180811/4.jpg' style='width: 100%; height: auto;' />  " +
            "--중간에 너무 힘들어서 다음 공연 전까지 그냥 누워버렸다. 같이 찍힌 건 같이 간 친한 동생, 찍어준 사람은 그 동생의 친구디.  " +
            "  " +
            "<img src='./static/photos/penta-20180811/5.jpg' style='width: 100%; height: auto;' />  " +
            "--하이네켄 맥주, 땀을 흘리고 날도 더우니 맥주를 정말 많이 마셨다. 락페스티벌의 재미있는 점은 맥주를 아무리 마셔도 화장실을 안간다는 점이다. 땀으로 물이 다 나온다.  " +
            "  " +
            "<img src='./static/photos/penta-20180811/6.jpg' style='width: 100%; height: auto;' />  " +
            "--마이크 시노다, 작년에 죽은 체스터 베닝턴이 보컬로 있던 린킨파크라는 밴드의 기타리스트였디. 린킨파크는 사실상 활동 정지상태지만 시노다는 솔로로 활동을 하고있다. 락, 일렉트릭, 랩이 섞인 노래가 많다. 나는 시노다 티셔츠도 샀다.  "
        }
    ]
}