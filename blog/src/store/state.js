...
export default {
    postlist: [ 
        ...
        },
        {
            ...
            "--나는 그들이 어떤 개발자인지 모른다. 아무리 실력좋은 개발자라도 위에서 말하면 어쩔 수 없지. 라고 생각할지도 모른다. 하지만 이것이 옳은 소프트웨어 관리 방식은 절대 아니기 때문에, 이걸 그들도 알고 있다는 걸 내가 알기 때문에, 그들을 좋은 개발자라고 부르기가 꺼려진다. 나는 그들보다 좋은 개발자야! 라고 말하는 게 아니다. 다만 그 무리한 일을 같이 해야하는 내 입장에서 그들을 좋게 말할 수 없을 따름인 것이다.  "
        }
    ]
}